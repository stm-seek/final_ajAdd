        ...
        <div class="card text-center mb-3 mt-3">
            <div class="card-header test">
                <ul class="nav nav-tabs card-header-tabs " id="navigation">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="canvas.php">Canvas</a>
                    </li>
            ...
            <div class="tab-content text-start p-3 info-zone">
                ...
                <div class="imageZone">
                    <div class="img1">
                        <img width="100%" src="https://stepstraining.co/wp-content/uploads/2021/06/business-model-canvas-ideas.png" alt="image">
                        <p>
